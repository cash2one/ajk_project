...
def parse_args():
    ...
    group2.add_argument("--timeout",type=int,default=15,help="timeout of request")
    ...
    def _get_proxy(self,html,country):
        """Parse the raw html into proxy list
            ...
            Return:
                ...
                ...]
            Changes to the page cause the previous IP fetch rule to have no data, rewriting the next fetch rule.
        """
